...
class Info(commands.Cog):
    ...
    async def invite(self, ctx: commands.Context):
        AdminLink = Button(
            ...
            url="https://discord.com/api/oauth2/authorize?client_id=923915598247915540&permissions=8&scope=bot%20applications.commands",
        )
        NonAdminLink = Button(
            style=ButtonStyle.link,
            label="Recommended",
            url="https://discord.com/api/oauth2/authorize?client_id=923915598247915540&permissions=1110216543415&scope=bot%20applications.commands",
        )
